...
source_dir = path/to/diffusion_model_graph_outputs/copy_paste/image_labels_npy
destination_dir = path/to/iffusion_model_graph_outputs/copy_paste/image_labels_total
